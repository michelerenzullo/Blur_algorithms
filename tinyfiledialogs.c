// "Tiny File Dialogs" is include to allow the capability to select a file to read in.
// Other than this, it is not part of the core Adaptive Recolouring Code.

// NOTE********************************************************************************
// To use with Code::Blocks need to copy libcomdlg32.a and libole32.a
// from   C:\TDM-GCC-64\x86_64-w64-mingw32\lib
// to     C:\opencv\build\install\x64\mingw\lib
// and then add these to Link Libraries under Linker Settings in Code::Blocks
